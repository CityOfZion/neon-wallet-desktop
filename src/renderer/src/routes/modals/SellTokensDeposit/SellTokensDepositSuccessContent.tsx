...
export const SellTokensDepositSuccessContent = ({ transaction, account }: TProps) => {
  ...
  return (
    <div className="flex flex-col w-full flex-grow min-h-0 gap-14">
      <div className="flex flex-col min-h-0 p-3 pb-4 bg-asphalt mt-6 rounded">
