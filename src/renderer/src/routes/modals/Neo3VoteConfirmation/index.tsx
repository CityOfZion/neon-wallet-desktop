...
const Neo3VoteConfirmationModal = () => {
  const { t } = useTranslation('modals', { keyPrefix: 'neo3VoteConfirmation' })
  const { neo3Account, candidate } = useModalState<TModalState<'neo3-vote-confirmation'>>()
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      modalNavigate('neo3-vote-success', { replace: true, state: { neo3Account, candidate } })
    } catch (error) {
