...
export const Neo3EncryptDappPermission = ({ request, session, onAccept, onReject }: TDappPermissionComponentProps) => {
  const { t } = useTranslation('modals', { keyPrefix: 'dappPermission.requests.neo3.encrypt' })
