...
export const Neo3VoteListItem = ({
  ...
  const handleGoToNeo3VoteCandidateDetailsModal = () => {
    modalNavigate('neo3-vote-candidate-details', {
  ...
  const handleGoToNeo3VoteConfirmationModal = () => {
    ...
    modalNavigate('neo3-vote-confirmation', { state: { neo3Account: neo3Account!, candidate } })
  }
        ...
        >
          ...
          >
            <IconButton
              ...
              onClick={handleGoToNeo3VoteCandidateDetailsModal}
            />
          </Tooltip>
        </div>
