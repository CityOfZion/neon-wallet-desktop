...
export const modalsRouter: TRoute[] = [
  ...
  { name: 'create-wallet-step-2', type: 'side', element: <CreateWalletStep2Modal /> },
  { name: 'create-wallet-step-3', type: 'side', element: <CreateWalletStep3Modal /> },
  { name: 'create-wallet-step-4', type: 'side', element: <CreateWalletStep4Modal /> },
  ...
  { name: 'dapp-permission-contract-details', type: 'center', element: <DappPermissionContractDetailsModal /> },
